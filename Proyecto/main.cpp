...
//------------- FUNCION DE COMBATE -------------//
void combat(int x, Personaje *a, Personaje *b, Jugador c){
    ...
    //------------- Malo 2 -------------//
        ...
        if (input == 1){
            ...
            if (prob == 1){
                ...
                cout << "Tu vida ahora es: " << c.get_vida() << endl;
                cout << "La vida del" << b->get_name() << "es de: " << b->get_vida() << endl;
    ...
    while(option != 10){
        ...
        case 3: //Viajar a una zona
            ...
            if (zone == 1){
                ...
                Personaje *malo_1 = new Malvado("Espada de madre", "Goblin", 5, 3, 10, 10, Zona_oscura.get_lvl_enemis(), 1);
                Personaje *malo_2 = new Malvado("Espada de pieda", "Esqueleto", 6, 3, 10, 10, Zona_oscura.get_lvl_enemis(), 1);
                ...
                if (vamos == "y"){ //Elegir si
                    ...
                    combat(Zona_oscura.get_num_enemis(), malo_1, malo_2, user);
            ...
            // Eleccion Bosque
                ...
                //Creamos objetos correspondientes
                Personaje *malo_1B = new Malvado("Espada de madera", "Tilin", 1, 2, 2, 10, bosque.get_lvl_enemis(), 1);
                Personaje *malo_2B = new Malvado("Espada de piedra", "Tilin Insano", 5, 2, 2, 10, bosque.get_lvl_enemis(), 1);
                ...
                if (vamos == "y"){ //Elegir si
                    cout << "Te adentras a lo profundo de la zona obscura... " << endl;
                    combat(bosque.get_num_enemis(), malo_1B, malo_2B, user);
